...
func (l *PlayerLoader) Load(key int) (*model.Player, error) {
...
func (l *PlayerLoader) LoadThunk(key int) func() (*model.Player, error) {
	l.mu.Lock()
...
func (l *PlayerLoader) LoadAll(keys []int) ([]*model.Player, []error) {
...
// This method should be used if you want one goroutine to make requests to many
// different data loaders without blocking until the thunk is called.
func (l *PlayerLoader) LoadAllThunk(keys []int) func() ([]*model.Player, []error) {
	results := make([]func() (*model.Player, error), len(keys))
	for i, key := range keys {
		results[i] = l.LoadThunk(key)
	}
...
func (l *PlayerLoader) Prime(key int, value *model.Player) bool {
	l.mu.Lock()
	var found bool
...
func (l *PlayerLoader) unsafeSet(key int, value *model.Player) {
	if l.cache == nil {
